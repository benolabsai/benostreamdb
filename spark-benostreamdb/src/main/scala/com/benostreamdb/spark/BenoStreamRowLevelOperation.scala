...
class BenoStreamRowLevelOperation(
  ...
  override def description(): String = s"BenoStream RowLevelOperation: ${info.command()}"
  ...
  override def newScanBuilder(options: CaseInsensitiveStringMap): ScanBuilder = {
    ...
    new BenoStreamScanBuilder(table, options)
  }
  ...
  override def newWriteBuilder(writeInfo: LogicalWriteInfo): WriteBuilder = {
    ...
    new BenoStreamWriteBuilder(table, writeInfo, gpuDevice)
  }
