...
pub async fn upsert_points(
    ...
    // Convert Qdrant points into flat JSON documents for BenoStreamDB inference.
    ...
    let Some(doc_schema) = merged else {
        return generic_err("No points supplied", StatusCode::BAD_REQUEST);
    };
