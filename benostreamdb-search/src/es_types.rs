...
impl From<BenoStreamError> for EsError {
    fn from(err: BenoStreamError) -> Self {
        match &err {
            BenoStreamError::PrimaryKeyViolation { key } => EsError {
                error: EsErrorBody {
            ...
            BenoStreamError::TableNotFound { .. } => EsError {
                error: EsErrorBody {
            ...
            BenoStreamError::InvalidUri { .. } => EsError {
                error: EsErrorBody {
            ...
            BenoStreamError::NullConstraintViolation { .. } => EsError {
                error: EsErrorBody {
                    error_type: "illegal_argument_exception".into(),
                    reason: err.to_string(),
                },
            ...
            BenoStreamError::ColumnNotFound { .. } => EsError {
                error: EsErrorBody {
                    error_type: "illegal_argument_exception".into(),
                    reason: err.to_string(),
                },
