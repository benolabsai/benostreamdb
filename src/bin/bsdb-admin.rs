...
#[derive(Parser, Debug)]
#[command(name = "benostreamdb-admin")]
#[command(about = "Administrative tooling for BenoStreamDB", version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
}
...
async fn main() -> anyhow::Result<()> {
    ...
    match &cli.command {
        Commands::Compact {
            ...
            let opts = benostreamdb::core::compaction::CompactionOptions {
