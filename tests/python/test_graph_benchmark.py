...
def hdb_table(tmpdir_factory, ba_graph):
    print("Ingesting to BenoStreamDB...")
    ...
    for u, v in ba_graph.edges():
        ...
        # make undirected graph into directed edges for BSDB
...
def test_benchmark_shortest_path(ba_graph, hdb_table):
    ...
    print("Running BenoStreamDB Shortest Path...")
    start_hdb = time.time()
    ...
    # Wait, our BSDB table doesn't have a weight column for this fixture.
...
def test_benchmark_wcc(ba_graph, hdb_table):
    ...
    print("Running BenoStreamDB WCC...")
    start_hdb = time.time()
